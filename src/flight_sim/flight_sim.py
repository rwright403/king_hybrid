...
oxidizer_tank = MassFlowRateBasedTank(
    ...
    geometry=tank_shape,
    flux_time=5.2,
    initial_liquid_mass=constants.V_tank*constants.rho_ox_liq*constants.fill_level,
    initial_gas_mass=constants.V_tank*constants.rho_ox_gas*(1-constants.fill_level),
