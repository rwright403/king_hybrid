...
def single_solve_T_dot_liq_gas(V_dot_liq, liq_state, sat_surf, gas_state, P_tank, m_liq, m_gas, V_liq, V_gas, m_dot_inj, m_dot_evap, m_dot_cond, Q_dot_liq, Q_dot_gas, m_dot_vent, m_dot_liq_in, h_liq_in, debug_mode):
...
def P_dot_error(V_dot_guess, liq_state, sat_surf, gas_state, P_tank, m_liq, m_gas, V_liq, V_gas, m_dot_inj, m_dot_evap, m_dot_cond, Q_dot_liq, Q_dot_gas, m_dot_vent, m_dot_liq_in, h_liq_in):    
    ...
    T_dot_liq, T_dot_gas = single_solve_T_dot_liq_gas(V_dot_guess, liq_state, sat_surf, gas_state, P_tank, m_liq, m_gas, V_liq, V_gas, m_dot_inj, m_dot_evap, m_dot_cond, Q_dot_liq, Q_dot_gas, m_dot_vent, m_dot_liq_in, h_liq_in, False)
...
class non_equilibrium_tank_model():
    ...
    def system_of_liq_odes(self, t, y, P_cc, m_dot_liq_in, h_liq_in):
        ...
        T_dot_liq, T_dot_gas = single_solve_T_dot_liq_gas(V_dot_liq, liq_state, sat_surf, gas_state, P_tank, m_liq, m_gas, V_liq, V_gas, m_dot_inj, m_dot_evap, m_dot_cond, Q_dot_liq, Q_dot_gas, m_dot_vent, m_dot_liq_in, h_liq_in, True)
    ...
    def inst(self, P_cc, m_dot_liq_in, h_liq_in):
        ...
        #print("T_gas: ", self.T_gas)

        t = 0
        y0 = [self.T_liq, self.T_gas, self.m_liq, self.m_gas, self.T_wall_liq, self.T_wall_gas]
        y_new = rk4_step(self.system_of_liq_odes, 0.0, y0, self.timestep, P_cc, m_dot_liq_in, h_liq_in)
...
def append_dat(t, dat, tank):
    ...
    try:
        ...
        dat.T_sat_arr.append(sat_surf.T)
    except Exception:
...
try:
    ...
    while( t <=1000*TIMESTEP): #pcnt_fill < full_pcnt_fill):
