...
fins_span = 0.127               # [m]                                               base to tip of fin (conctor to the rocket to outside most edge)
fins_root_chord = 0.32           # [m]                                               lostgest distance up    
fins_tip_chord = 0.09           # [m]                                               shortest distance up
fins_position = 0.4             # [m] csys: "tail_to_nose"                          Change as required "if is hanging off the rocket"
gamma_LE_sweep = 30             # [degrees]
#TODO: 0.25" 
fin_root_thickness = 6.35e-3        # [m]
...
ox_tank_pos = 2           # [m] csys: "tail_to_nose"
