...
def build_cantera_from_cea(oxName="N2O", fuelName="C2H5OH",Pc=3e6, OF=6.0, eps=40.0,nasa_file="nasa_gas.yaml"):
    """
...
class CombustionChamberLookup:
    def __init__(self, fuel="C2H5OH", oxidizer="N2O",
        ...
        self.gas, sp_list = build_cantera_from_cea(oxidizer, fuel, Pc=3e6, OF=6.0)
    ...
    def query(self, u, rho, OF):
        ...
        Returns dict with T, P, h, cp, gamma, MW.
        """
        pt = (rho, OF, u)
        props = {
